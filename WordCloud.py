# WordCloud: This program takes in a text file and creates a word cloud out of it.
...
def calculate_frequencies(file_contents):
    ...
    for ii in words:
        ii = ii.casefold()
        if ii not in freq and ii.isalpha() and ii not in uninteresting_words and ii not in punctuations:
            freq[ii] = 1
        elif ii in freq:
            freq[ii] += 1
